...
const Resetpassword = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <h1 onClick={()=>navigate('/')} className=' absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'>Authentication</h1>
    ...
    {!isEmailSent &&
      ...
      <p className=' text-center mb-6 text-indigo-300 '>Enter your registered email address.</p>
        ...
        <div className=' mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5c]'>
          ...
          <input
            className=' bg-transparent outline-none text-white' type="email" placeholder='Email id'
      ...
      <p className=' text-center mb-6 text-indigo-300 '>Enter the new password below.</p>
        ...
        <div className=' mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5c]'>
          ...
          <input
            ...
            value={newPassword}
            className=' bg-transparent outline-none' type="password" placeholder='New password' required/>
